...
<div class="container">
  <h1 align="left">${patologia.nombre}</h1>
            
    <center><table style="backgroundcolor="white"; opacity: 0,5; filter:alpha(opacity=50)" class="table table-bordered">
    <tbody>
    <tr>
        <td><img src= "${patologia.ruta_foto}" class="img-rounded" alt="Cinque Terre" width="404" height="300"></td>
        <td align="left"> <br><b>DESCRIPCIÓN  </b><br><br>${patologia.descripcion}<br></td>
